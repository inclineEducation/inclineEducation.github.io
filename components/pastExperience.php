...
<div class="section experience" data-aos="fade-up" data-aos-delay="" style="padding-top: 2rem">
    <div class="container">
      ...
      <div class="row" style="justify-content:center">
        ...
        <!-- Deloitte -->
        <div class="col-lg-4 mb-4 text-center Aligner">
          <div class="service aligner-item--top" >
            <img src="/images/misc/logos/Deloitte.png" target="_blank" alt="Deloitte" width="100%"><img>
          </div>
        </div>
        ...
        <div class="col-lg-3 mb-4 text-center Aligner">
          <div class="service aligner-item--top">
            <img src="/images/misc/logos/KPMG.png" target="_blank" alt="KPMG" width="100%"><img>
          </div>
        </div>
        ...
        <div class="col-lg-4 mb-4 text-center Aligner">
          <div class="service aligner-item--top">
            <img src="/images/misc/logos/Microsoft.png" target="_blank" alt="Microsoft" width="100%"><img>
          </div>
        </div>
        ...
        <div class="col-lg-2 mb-4 text-center Aligner">
          <div class="service aligner-item--top">
            <img src="/images/misc/logos/PWC_2.png" target="_blank" alt="PWC" width="100%"><img>
          </div>
        </div>
