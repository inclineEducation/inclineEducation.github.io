...
<body>
    ...
    <div class="container">
      <div class="row slider-text align-items-center justify-content-center text-center">
        <div class="col-lg-12 col-sm-12">
          <h1 class="mb-4" data-aos="fade-right" data-aos-delay="">Privacy Policy</h1>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="section portfolio-section">
    <div class="container">
      <div class="row mb-5 justify-content-center">
        <div class="col-md-25" style="padding: 1em;">
		  <h1 class="mb-4 section-title" data-aos="fade-right" data-aos-delay="">Welcome to our Privacy Policy</h1>
		  <!--<h3 class="mb-4 section-title" data-aos="fade-right" data-aos-delay="">Welcome to Incline Education</h3>-->
          <p data-aos="fade-right" data-aos-delay=""><em><b>Your privacy is critically important to us.</b></em><p>
		<!--
		Incline Education is located at:<br/>
		<address>
		  Incline Education<br/><br/>4036180178			</address>
		-->
		<p data-aos="fade-right" data-aos-delay="">It is Incline Education's policy to respect your privacy regarding any information we may collect while operating our website. This Privacy Policy applies to <a href="http://inclineedu.org">inclineedu.org</a> 
		(hereinafter, "us", "we", or "inclineedu.org"). We respect your privacy and are committed to protecting personally identifiable information you may provide us through the Website. We have adopted this privacy policy ("Privacy Policy") to explain what 
		information may be collected on our Website, how we use this information, and under what circumstances we may disclose the information to third parties. This Privacy Policy applies only to information we collect through the Website and does not apply 
	...
	<!--
		...
		you or others who use your computer. This information allows ad networks to, among other things, deliver targeted advertisements that they believe will be of most interest to you. This Privacy Policy covers the use of cookies by Incline Education 
	...
	-->
		...
		information to anyone. Other than to its employees, contractors and affiliated organizations, as described above, Incline Education discloses potentially personally-identifying and personally-identifying information only in response to a subpoena, 
		court order or other governmental request, or when Incline Education believes in good faith that disclosure is reasonably necessary to protect the property or rights of Incline Education, third parties or the public at large.</p>
		<p data-aos="fade-right" data-aos-delay="">If you have supplied your email address, Incline Education may occasionally send you an email to tell you about new features, solicit your feedback, or just keep you up to date with what's going on with 
		Incline Education. We primarily use our blog to communicate this type of information, so we expect to keep this type of email to a minimum. If you send us a request (for example via a support email or via one of our feedback mechanisms), we reserve 
		...
		advertisements on its website and as such, none of your personal information is being
		commercially. You can read more about what information is collected <a href="https://policies.google.com/technologies/partner-sites?hl=en-GB&gl=uk">here</a></p>
