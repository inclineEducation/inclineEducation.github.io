    ...
    <div class="container">
      <div class="row slider-text align-items-center justify-content-left text-left" style="height: calc(60vh); min-height: 400px;">
        <div class="col-lg-12 col-sm-12">
          <h1 data-aos="fade-up" style="font-size:calc(2rem + 1vw);"> [ TITLE ]</h1>
          <h2 data-aos="fade-up" style="color: white; font-size: calc(1.15rem + 1.15vw);"> [ SUBTITLE ]</h2>
          <p data-aos="fade-up" style="font-size: calc(0.5rem + 0.25vw);"><em>Posted by [ NAME ] on [ DATE ], 2020</em></p>
        </div>
      </div>
    </div>
  </div>
