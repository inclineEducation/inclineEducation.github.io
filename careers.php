    ...
    <div class="container">
      <div class="row mb-5 justify-content-center">
        <div class="col-md-8 text-center" style="padding: 1em;">
          ...
          you can rest assured that our team and advisory board will be there to support you. 
          </p>
          <br>
          ...
          of students from 8+ countries around the world and spanning 10+ different post-secondary programs. 
          </p>
